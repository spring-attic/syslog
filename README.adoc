...
include::spring-cloud-starter-stream-source-syslog/README.adoc[]
...
Please use/build the 1.3.x branch or the [Celsius.SR1 release](http://repo.spring.io/libs-release/org/springframework/cloud/stream/app/) of the applications - it is the latest GA release.
